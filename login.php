...
?>
<div class="row m-h-400 column-comp-9 column-tablet-9 column-cel-10 centrado m-b-30">
    <div class="column-comp-4 column-tablet-4 column-cel-10 h-400 bg-oscuro-transparente borde-radio-10 cont-centrado">
        <form action="/FerreLineWeb/valida_usuario.php" method="POST" class="column-comp-10 cont-centrado">
            <div class="row column-comp-8 column-tablet-8 column-cel-8">
                ...
                <div class="column-comp-10 column-tablet-10 column-cel-10 m-b-40">
                    <label for="" class="blanco">Cédula<input type="number" name="cedula" class="text-comp text-tablet text-cel column-comp-10 column-tablet-10 column-cel-10"></label>
                </div>
                <div class="column-comp-10 column-tablet-10 column-cel-10 m-b-10">
                    <label for="" class="blanco">Contraseña<input type="password" name="contrasena" class="text-left text-comp text-tablet text-cel column-comp-10 column-tablet-10 column-cel-10"></label>
                </div>
