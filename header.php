			...
			<div class="row">
				...
				<div class="column-comp-6 column-tablet-10 column-cel-10 cont-centrado">
					<form action="" class="cont-centrado w-90">
						<input type="text" class="text-comp text-tablet text-cel column-comp-7 column-tablet-8 column-cel-7" placeholder="Busca aquí...">
						<input type="submit" class="boton-comp boton-tablet boton-cel btn-azul column-comp-3 column-tablet-2 column-cel-3" value="Buscar">
					</form>
				</div>
			</div>
		</div>
		<div class="column-comp-4 column-tablet-4 column-cel-10 cont-centrado inferior h-1-5">
			<div class="row h-100 cont-centrado">
				<div class="column-comp-4 column-tablet-4 column-cel-4 cont-centrado">
					<img src="https://cdn.icon-icons.com/icons2/1154/PNG/512/1486564402-settings_81520.png" class="h-0-7" alt="">
				</div>
