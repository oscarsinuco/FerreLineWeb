...
<div id="menu">
	...
	<div class="contenedor" style="height: 1250px;">
		<div class="encabezado"><h1>EMPLEADO</h1></div>
		<div class="cuerpo">
			<form onsubmit="return validartodo3()" name="empleado" action="empleado.php" method="POST">
				<label>Id empleado</label>
				<input type="text" name="id_empleado" class="texto text1" id="id_empleado" onchange="num('id_empleado')" >
				...
				<select name="id_nomina" class="selector texto" id="id_nomina" onchange="num('id_nomina')">
					<option disabled value="" selected>
							Seleccione...
						</option>
						<?php
				...
				<textarea rows="4" cols="30" name="direccion" class="texto text1" id="direccion" onchange="novacio('direccion')"></textarea>
				<label>Cedula</label>
